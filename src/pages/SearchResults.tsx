...
import { Box, Breadcrumb, BreadcrumbItem, BreadcrumbLink, Text, Grid } from "@chakra-ui/react";
...
const SearchResults = () => {
    ...
    const foundProducts = products.filter(
        (product) =>
            (product && product.title && product.title.toLowerCase().includes(name.toLowerCase())) ||
            (product.description && product.description.toLowerCase().includes(name.toLowerCase())) ||
