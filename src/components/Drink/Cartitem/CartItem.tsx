import { Box, Flex, Text, Image, Button, Select, LinkBox, LinkOverlay, useToast } from "@chakra-ui/react";
...
const CartItem = ({ product }: Props) => {
    ...
    return (
        <Flex display={{ base: "none", bigTablet: "flex" }} boxShadow="base" mb={4} rounded="base">
            <Flex
                as={LinkBox}
                p={3}
                w="70%"
            ...
            >
                <Image src={product.imageUrl} alt={product.imageAlt} boxSize="100px" mr={2} />
            ...
            <Flex w="30%" borderRight="2px solid" borderColor="blackAlpha.200" justify="center" align="center">
                <Select
                    size="sm"
                    minW={12}
                    maxW={16}
                    ...
                    onChange={(e: ChangeEvent<HTMLSelectElement>) => setQuantity(e.target.value, product.id)}
                >
            ...
            <Flex w="30%" fontWeight="bold" fontSize="lg" justify="center" align="center">
                ${subTotal.toFixed(2)}
            </Flex>
        </Flex>
    );
